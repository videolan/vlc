...
struct pl_color_space vlc_placebo_ColorSpace(const video_format_t *fmt)
{
    ...
    return (struct pl_color_space) {
        ...
        .hdr = {
            .prim = {
                .green.x = fmt->mastering.primaries[0] / 50000.0f,
                .green.y = fmt->mastering.primaries[1] / 50000.0f,
                .blue.x  = fmt->mastering.primaries[2] / 50000.0f,
                .blue.y  = fmt->mastering.primaries[3] / 50000.0f,
                .red.x   = fmt->mastering.primaries[4] / 50000.0f,
                .red.y   = fmt->mastering.primaries[5] / 50000.0f,
                .white.x = fmt->mastering.white_point[0] / 50000.0f,
                .white.y = fmt->mastering.white_point[1] / 50000.0f,
            },
