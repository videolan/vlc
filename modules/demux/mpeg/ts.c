...
static stime_t GetTimeForUntimed( const ts_pmt_t *p_pmt )
{
    stime_t i_ts = p_pmt->pcr.i_current;
...
static void PESDataChainHandle( vlc_object_t *p_obj, void *priv, block_t *p_data, stime_t i_append_pcr )
{
