...
static inline bool ExtractPESTimestamp( const uint8_t *p_data, uint8_t i_flags, stime_t *ret )
{
    ...
    *ret =  ((stime_t)(p_data[ 0]&0x0e ) << 29)|
             (stime_t)(p_data[1] << 22)|
            ((stime_t)(p_data[2]&0xfe) << 14)|
             (stime_t)(p_data[3] << 7)|
             (stime_t)(p_data[4] >> 1);
    return true;
}
...
{
    return ((stime_t)(p_data[ 0]&0x38 ) << 27)|
            ((stime_t)(p_data[0]&0x03 ) << 28)|
             (stime_t)(p_data[1] << 20)|
            ((stime_t)(p_data[2]&0xf8 ) << 12)|
            ((stime_t)(p_data[2]&0x03 ) << 13)|
             (stime_t)(p_data[3] << 5) |
             (stime_t)(p_data[4] >> 3);
}
