/*****************************************************************************
 * qt_palette.h: color definitions for qt
 *****************************************************************************
 ...
 *****************************************************************************/
#ifndef VLC_QT_PALETTE_H_
#define VLC_QT_PALETTE_H_

#include <vlc_es.h>

/* Tables stol^C borrowed from libavformat/qtpalette.c */
...
static const uint8_t * qt_get_default_palette(uint8_t depth)
{
    switch(depth)
    {
    case 1:
        return qt_default_palette_2;
    case 2:
        return qt_default_palette_4;
    case 4:
        return qt_default_palette_16;
    case 8:
        return qt_default_palette_256;
    default:
        return NULL;
    }
}
...
{
    const uint8_t *srcpal = qt_get_default_palette(depth);
    if(!srcpal)
        return NULL;
...
#define qt_palette_depth_has_default(depth) (!!qt_get_default_palette(depth))
