...
- (void)awakeFromNib
{
    ...
    if (!b_dark_interface) {
        ...
        [o_bwd_btn setImage: [NSImage imageNamed:@"back-3btns"]];
        [o_bwd_btn setAlternateImage: [NSImage imageNamed:@"back-3btns-pressed"]];
        [o_detached_bwd_btn setImage: [NSImage imageNamed:@"back-3btns"]];
        [o_detached_bwd_btn setAlternateImage: [NSImage imageNamed:@"back-3btns-pressed"]];
    ...
    else
    {
        ...
        [o_bwd_btn setImage: [NSImage imageNamed:@"back-3btns-dark"]];
        [o_bwd_btn setAlternateImage: [NSImage imageNamed:@"back-3btns-dark-pressed"]];
        [o_detached_bwd_btn setImage: [NSImage imageNamed:@"back-3btns-dark"]];
        [o_detached_bwd_btn setAlternateImage: [NSImage imageNamed:@"back-3btns-dark-pressed"]];
