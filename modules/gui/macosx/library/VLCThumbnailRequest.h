/*****************************************************************************
* VLCThumbnailRequest.h: MacOS X interface module
*****************************************************************************
...
@class VLCLibraryImageCache;

typedef void (^VLCThumbnailCompletion)(NSImage * _Nullable image);

@interface VLCThumbnailRequest : NSObject
