...
LIBEBML_URL=http://dl.matroska.org/downloads/libebml/libebml-$(LIBEBML_VERSION).tar.gz
LIBMATROSKA_VERSION=0.7.0
LIBMATROSKA_URL=http://dl.matroska.org/downloads/libmatroska/libmatroska-$(LIBMATROSKA_VERSION).tar.gz
...
#LIVEDOTCOM_VERSION=2004.06.18
LIVEDOTCOM_URL=$(VIDEOLAN)/testing/contrib/live.$(LIVEDOTCOM_VERSION).tar.gz
#LIVEDOTCOM_URL=http://live.com/liveMedia/public/live.2004.06.18.tar.gz
