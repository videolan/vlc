...
PKGCFG_URL=http://www.freedesktop.org/software/pkgconfig/releases/pkgconfig-$(PKGCFG_VERSION).tar.gz
LIBICONV_VERSION=1.9.1
LIBICONV_URL=$(GNU)/libiconv/libiconv-$(LIBICONV_VERSION).tar.gz
GETTEXT_VERSION=0.14.1
GETTEXT_URL=$(VIDEOLAN)/contrib/gettext-$(GETTEXT_VERSION).tar.gz
...
GOOM2k4_URL=$(SF)/goom/goom2k4-$(GOOM2k4_VERSION).tar.gz
LIBCACA_VERSION=0.9
