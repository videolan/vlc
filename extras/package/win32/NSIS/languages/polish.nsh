...
StrCpy $Desc_Section02a "Dodaje skrót łatwego dostępu w Twoim Menu Start"
StrCpy $Desc_Section02b "Dodaje ikonę łatwego dostępu na Twoim pulpicie"
StrCpy $Desc_Section03 "Wtyczka VLC Mozilla i Mozilla Firefox"
StrCpy $Desc_Section04 "Wtyczka VLC ActiveX"
StrCpy $Desc_Section05 "Rejestracja VLC do odtwarzania płyt DVD i CD"
StrCpy $Desc_Section06 "Ustawia VLC media player jako domyślną aplikację dla poszczególnego typu pliku"
StrCpy $Desc_Section07 "Dodaje nowe pozycje do menu kontekstowego ('Odtwórz w VLC' i 'Dodaj do listy odtwarzania VLC')"
StrCpy $Desc_Section08 "Usuwa ustawienia odtwarzacza VLC media player i pamięci podręcznej poprzednich instalacji"
StrCpy $Name_Section91 "Odinstaluj"
StrCpy $Name_Section92 "Wyczyścić pamięć podręczną i usunąć ustawienia"
StrCpy $Desc_Section91 "Odinstaluj VLC media player i wszystkie jego składniki"
StrCpy $Desc_Section92 "Usuwa ustawienia odtwarzacza VLC media player i pamięci podręcznej"
