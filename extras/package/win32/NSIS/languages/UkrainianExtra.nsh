...
${LangFileString} Desc_Section91 "Видалити медіапрогравач VLC та усі його компоненти"
${LangFileString} Desc_Section92 "Вилучає налаштування медіапрогравача VLC та файли кешу"
