...
${LangFileString} Desc_Section01 "媒體播放器本體"
${LangFileString} Desc_Section02a "在開始功能表新增啟動圖示以利存取"
${LangFileString} Desc_Section02b "在桌面新增圖示以利存取"
${LangFileString} Desc_Section03 "VLC Mozilla 與 Mozilla Firefox 外掛"
${LangFileString} Desc_Section04 "VLC ActiveX 外掛"
${LangFileString} Desc_Section05 "註冊 DVD 與 CD 播放"
${LangFileString} Desc_Section06 "設定 VLC 媒體播放器為特定檔案類型的預設程式"
${LangFileString} Desc_Section07 "新增右鍵選單項目 (「以 VLC 播放」與「新增至 VLC 播放清單」)"
${LangFileString} Desc_Section08 "刪除上一個 VLC 媒體播放器安裝留下來的偏好設定與快取"
${LangFileString} Name_Section91 "移除"
${LangFileString} Name_Section92 "刪除偏好設定與快取"
${LangFileString} Desc_Section91 "移除 VLC 媒體播放器與所有元件"
${LangFileString} Desc_Section92 "刪除 VLC 媒體播放器偏好設定與快取"
