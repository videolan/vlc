...
static const char * const ppsz_deinterlace_mode[] = {
    ...
    "ivtc", "gl_yadif", "gl_yadif2x", "gl_bwdif", "gl_bwdif2x",
};
static const char * const ppsz_deinterlace_mode_text[] = {
    ...
    N_("Film NTSC (IVTC)"), N_("OpenGL Yadif"), N_("OpenGL Yadif (2x)"),
    N_("OpenGL Bwdif"), N_("OpenGL Bwdif (2x)"),
};
...
/* Input options */
    ...
    add_integer( "restore-playback-pos", VLC_PLAYER_RESTORE_PLAYBACK_POS_ASK,
                 RESTORE_PLAYBACK_POS_TEXT, RESTORE_PLAYBACK_POS_TEXT )
