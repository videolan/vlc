...
vlcInput_get_length( PyObject *self, PyObject *args )
{
    ...
    vlc_int64_t i_ret;
    LIBVLC_TRY;
    i_ret = libvlc_media_instance_get_length( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
...
vlcInput_get_time( PyObject *self, PyObject *args )
{
    ...
    vlc_int64_t i_ret;
    LIBVLC_TRY;
    i_ret = libvlc_media_instance_get_time( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "L", i_ret );
}
...
vlcInput_set_time( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_media_instance_set_time( libvlc_media_instance->p_md, i_time, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_get_position( PyObject *self, PyObject *args )
{
    ...
    float f_ret;
    LIBVLC_TRY;
    f_ret = libvlc_media_instance_get_position( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
...
vlcInput_set_position( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_media_instance_set_position( libvlc_media_instance->p_md, f_pos, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_will_play( PyObject *self, PyObject *args )
{
    ...
    int i_ret;
    LIBVLC_TRY;
    i_ret = libvlc_media_instance_will_play( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
...
vlcInput_get_rate( PyObject *self, PyObject *args )
{
    ...
    float f_ret;
    LIBVLC_TRY;
    f_ret = libvlc_media_instance_get_rate( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "f", f_ret );
}
...
vlcInput_set_rate( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_media_instance_set_rate( libvlc_media_instance->p_md, f_rate, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_get_state( PyObject *self, PyObject *args )
{
    ...
    int i_ret;
    LIBVLC_TRY;
    i_ret = libvlc_media_instance_get_state( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_has_vout( PyObject *self, PyObject *args )
{
    ...
    int i_ret;
    LIBVLC_TRY;
    i_ret = libvlc_media_instance_has_vout( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_get_fps( PyObject *self, PyObject *args )
{
    ...
    float f_ret;
    LIBVLC_TRY;
    f_ret = libvlc_media_instance_get_fps( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "f", f_ret );
}
...
vlcInput_audio_get_track( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    i_ret = libvlc_audio_get_track( libvlc_media_instance->p_md, &ex );
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_audio_set_track( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_audio_set_track( libvlc_media_instance->p_md, i_track, &ex );
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_toggle_fullscreen( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_toggle_fullscreen( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;    
}
...
vlcInput_set_fullscreen( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_set_fullscreen( libvlc_media_instance->p_md, i_fullscreen, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_get_fullscreen( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    i_ret = libvlc_get_fullscreen( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_get_height( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    i_ret = libvlc_video_get_height( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_get_width( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    i_ret = libvlc_video_get_width( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
...
vlcInput_get_aspect_ratio( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    psz_ret = libvlc_video_get_aspect_ratio( libvlc_media_instance->p_md, &ex);
    LIBVLC_EXCEPT;
...
vlcInput_set_aspect_ratio( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_video_set_aspect_ratio( libvlc_media_instance->p_md, psz_ratio, &ex);
    LIBVLC_EXCEPT;
    free( psz_ratio );
    Py_INCREF( Py_None );
    return Py_None;
...
vlcInput_video_take_snapshot( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_video_take_snapshot( libvlc_media_instance->p_md, psz_filename, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_video_resize( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    libvlc_video_resize( libvlc_media_instance->p_md, i_width, i_height, &ex);
    LIBVLC_EXCEPT;
    Py_INCREF( Py_None );
    return Py_None;
}
...
vlcInput_video_reparent( PyObject *self, PyObject *args )
{
    ...
    LIBVLC_TRY;
    i_ret = libvlc_video_reparent( libvlc_media_instance->p_md, i_visual, &ex);
    LIBVLC_EXCEPT;
    return Py_BuildValue( "i", i_ret );
}
